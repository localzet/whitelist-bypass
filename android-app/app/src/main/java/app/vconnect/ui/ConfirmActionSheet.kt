...
class ConfirmActionSheet : BottomSheetDialogFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if (destructive) {
            ...
            titleView.setTextColor(app.vconnect.util.AccentColors.primary(context))
            confirm.backgroundTintList = ColorStateList.valueOf(app.vconnect.util.AccentColors.primary(context))
