...
class MainFragmentView(private val root: View) {
    ...
    fun bindHero(connected: Boolean, status: VpnStatus?) {
        ...
        if (connected) {
            ...
            heroLabel.setTextColor(app.vconnect.util.AccentColors.primary(context))
            heroPowerIcon.setColorFilter(app.vconnect.util.AccentColors.primary(context))
    ...
    fun showPingResult(success: Boolean, rttMs: Int) {
        ...
        if (success) {
            ...
            pingResultHost.setTextColor(app.vconnect.util.AccentColors.primary(root.context))
            pingResultRtt.setTextColor(app.vconnect.util.AccentColors.primary(root.context))
    ...
    private fun bindRow(row: View, config: CallConfig, isActive: Boolean) {
        ...
        linkView.text = config.routeLabel
        glyphView.text = config.routeGlyph
