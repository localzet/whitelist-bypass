...
import app.vconnect.MainActivity
...
class HeadlessSessionService : Service() {
    ...
    companion object {
        const val ACTION_STOP = "app.vconnect.STOP_HEADLESS_SESSION"
        const val ACTION_DEPENDENT_STOPPED = "app.vconnect.HEADLESS_DEPENDENT_STOPPED"
