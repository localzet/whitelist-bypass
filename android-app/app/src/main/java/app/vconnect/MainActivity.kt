...
import app.vconnect.tunnel.CallPlatform
import app.vconnect.tunnel.EgressProfileStatus
import app.vconnect.tunnel.HeadlessJoinController
import app.vconnect.tunnel.JoinController
import app.vconnect.tunnel.ServiceJoinController
import app.vconnect.tunnel.HeadlessSessionService
import app.vconnect.tunnel.PortGuard
import app.vconnect.tunnel.ProxyService
import app.vconnect.tunnel.TunnelMode
import app.vconnect.tunnel.TunnelServiceState
import app.vconnect.tunnel.TunnelVpnService
import app.vconnect.tunnel.VpnStatus
import app.vconnect.ui.CallsListener
import app.vconnect.ui.ChoiceActionSheet
import app.vconnect.ui.HeadlessVkFragment
import app.vconnect.ui.JoinFragmentHost
import app.vconnect.ui.JoinSessionShutdown
import app.vconnect.ui.JsHookJoinFragment
import app.vconnect.ui.LogsFragment
import app.vconnect.ui.MainActivityHost
import app.vconnect.ui.MainFragment
import app.vconnect.ui.SettingsScreenFragment
import app.vconnect.util.LogWriter
import app.vconnect.util.AccentMode
import app.vconnect.util.Net
import app.vconnect.util.Prefs
import app.vconnect.util.SocksAuth
import app.vconnect.util.maskUrl
...
class MainActivity :
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        setTheme(if (Prefs.accentMode == AccentMode.VIOLET) R.style.Theme_VConnect_Violet else R.style.Theme_VConnect)
    ...
    private fun applyNavVisual(icon: ImageView, label: TextView, emphasis: Float) {
        val accent = app.vconnect.util.AccentColors.primary(this)
    ...
    private fun startJoinFor(config: CallConfig) {
        ...
        val tunnelMode = config.effectiveTunnelMode(Prefs.tunnelMode)
        if ((config.tunnelMode ?: Prefs.tunnelMode) == TunnelMode.DC &&
    ...
    companion object {
        const val ACTION_AUTO_START = "app.vconnect.AUTO_START"
